...
// TCHandler represents the nic along with attached qdiscs and filters
...
// AddQdisc adds a new qdisc to the given nic of the current TCHandler.
// The tc command line utility is used under the hood to perform the required operations.
...
// AttachFilter attaches a new filter to the given nic of the current TCHandler.
